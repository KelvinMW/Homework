...
//    {
 ...
 //   }
   ...
   // {
//        $sql = "INSERT INTO {$this->tableName} ('Class', 'homeworkDueDateTime','onlineSubmission' gibbonPlannerEntryStudentHomeworkID	gibbonPlannerEntryID	gibbonPersonID	homeworkDueDateTime	homeworkDetails	homeworkComplete) VALUES (:value1, :value2)";
